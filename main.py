...
class Calculator(QMainWindow):
    def __init__(self):
        ...
        # math
        self.ui.btn_ans.clicked.connect(self.calculate)
    ...
    def disable_buttons(self, disable: bool) -> None:
        self.ui.btn_ans.setDisabled(disable)
        ...
        self.ui.btn_change.setDisabled(disable)
    ...
    def change_buttons_color(self, css_color: str) -> None:
        self.ui.btn_ans.setStyleSheet(css_color)
        ...
        self.ui.btn_change.setStyleSheet(css_color)
